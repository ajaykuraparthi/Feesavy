...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String clgname = studentViewModel.getClgname();

        TextView Name = rootView.findViewById(R.id.name);
        Name.setText(name);
        TextView Pinno= rootView.findViewById(R.id.pinno);
        Pinno.setText(pinno);
        TextView Departmentname= rootView.findViewById(R.id.Depname);
        Departmentname.setText(branch);
        TextView Year= rootView.findViewById(R.id.year);
        Year.setText(year);
        TextView Code= rootView.findViewById(R.id.code);
        Code.setText(code);
        TextView ClgName= rootView.findViewById(R.id.clgname);
        ClgName.setText(clgname);

        return rootView; // You need to return the rootView here
    }
